...
{
    public class ExternalPlatformType : ObjectGraphType<ProfileType>
    {
        public ExternalPlatformType()
        {
            ...
            Field<ListGraphType<ExternalPlatformEmailAlertType>>(nameof(ProfileType.EmailAlerts), "The email addresses to be alerted whenever a person with a profile of this type changes state.");
        }
    }
}
